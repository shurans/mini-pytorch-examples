...
def adjust_input_image_size_for_proper_feature_alignment(input_img_batch, output_stride=8):
    ...
    #input_img_batch_new_size = nn.functional.upsample_bilinear(input=input_img_batch, size=new_spatial_dims)
    input_img_batch_new_size = nn.functional.interpolate(input=input_img_batch, size=new_spatial_dims,
...
class Resnet18_8s(nn.Module):
    ...
    def forward(self, x, feature_alignment=False):
        ...
        #Newer method, upsample deprecated.
