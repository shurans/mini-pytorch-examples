...
def main():
    ...
    with concurrent.futures.ProcessPoolExecutor(1) as executor:
        ...
        # image_files_rgb = glob.glob(os.path.join(rgb_imgs_path, "*" + '-rgb.npy'))
        image_files_normals = glob.glob(os.path.join(camera_normals_path, "*" + SUBFOLDER_MAP['camera-normals']['postfix']))
